...
const RegistrationForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            ...
            setSubmitMsg(
                "✅ Registration request sent! Our team will review & onboard you within 48 hours."
            );
                    ...
                    <div className="relative rounded-[28px] border border-white/10 bg-white backdrop-blur-xl shadow-[0_0_50px_rgba(255,193,7,0.08)] p-6 sm:p-8 lg:p-10">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="rounded-xl border border-gray-300 bg-white/5 p-4">
                                    ...
                                    <p className="text-xs text-gray-700 mt-2">
                                        Showcase previous work (max 10 files)
                                    </p>
                                </div>

                                <div className="rounded-xl border border-gray-300 bg-white/5 p-4">
                                    <label className="block text-[#8B5A2B] font-medium mb-2">
                                        🖼️ Product Images Upload (jpeg/png)
                                    </label>
                                    <input
                                        type="file"
                                        multiple
                                    ...
                                    />
                                    <p className="text-xs text-gray-700 mt-2">
                                        Furniture, decor, installations, etc.
                                    </p>
                                </div>
                            </div>

                            {submitMsg && (
                                <div className="rounded-xl border border-green-500/30 bg-green-500/10 text-green-300 p-3 text-sm">
                                    {submitMsg}
                                </div>
                            )}
                            ...
                            <button
                                ...
                                className={`w-full rounded-xl bg-[#C6A43B] text-black font-semibold py-4 shadow-md transition-all flex justify-center items-center gap-2 hover:bg-[#d6b24a] ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""
                                    }`}
                            >
                            ...
                            <p className="text-xs text-gray-700 text-center">
                                By registering, you agree to JSGallor’s Vendor Terms & Partnership guidelines.
                            </p>
                        </form>
                    </div>
                </div>
